...
| SOA Suite (INTEG) | `soa_integ` | OSB, SOA, WSM | CC&B ↔ MDM integration (6 VMs) |
| SOA Suite (INTF) | `soa_intf` | OSB, SOA, BAM, ODI, WSM | External interfaces (ERP, payment) (9 VMs) |
| SOA Suite (WEB) | `soa_web` | OSB×4, SOA×4, BAM, WSM | Web portal integration (11 VMs) |
| SOA Suite (SGG) | `soa_sgg` | OSB×6, SOA×4, WSM | Itron AMI head-end (12 VMs) |
